...
export const getIssueCheckListToolParam = {
...
export const getIssueCommentsToolParam = {
...
export const getSprintToolParam = {
...
export const getBoardSprintsToolParam = {
...
export const getIssuePriorityTypesToolParam = {
...
export const searchIssueByQueryToolParam = {
  name: YandexTrackerToolName.searchIssueByQuery,
  systemPrompt: `
    Если пользователь не указал perPage или page, то ничего от себя не придумывай и не добавляй эти параметры в запрос.
...
export const getQueuesToolParam = {
